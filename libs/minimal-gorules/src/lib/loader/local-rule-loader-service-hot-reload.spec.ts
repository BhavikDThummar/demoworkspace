...
describe('LocalRuleLoaderService Hot Reload Integration', () => {
  ...
  describe('integration with rule loading', () => {
    ...
    it('should work with loadAllRules', async () => {
      ...
      await writeFile(path.join(tempDir, 'rule1.json'), JSON.stringify({ 
        name: 'Rule 1',
        nodes: [],
        edges: [],
        content: { test: 'rule1' }
      }));
      await writeFile(path.join(tempDir, 'rule2.json'), JSON.stringify({ 
        name: 'Rule 2',
        nodes: [],
        edges: [],
        content: { test: 'rule2' }
      ...
      await writeFile(path.join(tempDir, 'rule3.json'), JSON.stringify({ 
        name: 'Rule 3',
        nodes: [],
        edges: [],
        content: { test: 'rule3' }
    ...
    it('should work with individual rule loading', async () => {
      ...
      await writeFile(path.join(tempDir, 'individual-rule.json'), JSON.stringify({ 
