...
describe('TagManager', () => {
  ...
  describe('createExecutionOrder', () => {
    ...
    it('should detect circular dependencies', async () => {
      ...
      await expect(tagManager.createExecutionOrder(ruleIds, dependencies)).rejects.toThrow(
        'Circular dependency detected in rules',
      );
    });
  ...
  describe('resolveRules', () => {
    ...
    it('should throw error for invalid selector', async () => {
      ...
      await expect(tagManager.resolveRules(selector, mockRules)).rejects.toThrow(
        'Invalid rule selector provided',
      );
    });
