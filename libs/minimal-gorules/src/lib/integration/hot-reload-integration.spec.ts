...
describe('Hot Reload Integration Tests', () => {
  ...
  describe('Hot Reload with LocalRuleLoaderService Integration', () => {
    ...
    it('should handle rule change events and update cache automatically', async () => {
      ...
      await fs.promises.writeFile(rulePath, JSON.stringify({
        name: 'Test Rule',
        nodes: [
    ...
    it('should handle nested directory structure in hot reload', async () => {
      ...
      await fs.promises.writeFile(nestedRulePath, JSON.stringify({
        name: 'Shipping Fees',
        nodes: [],
        edges: []
      }));
    ...
    it('should handle hot reload configuration options', async () => {
      ...
      await fs.promises.writeFile(ignoredFilePath, JSON.stringify({
        name: 'Ignored Rule',
        nodes: [],
        edges: []
      }));
      ...
      await fs.promises.writeFile(normalFilePath, JSON.stringify({
        name: 'Normal Rule',
        nodes: [],
        edges: []
      }));
