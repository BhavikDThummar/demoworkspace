...
describe('GoRulesMonitoringService', () => {
  ...
  describe('circuit breaker monitoring', () => {
    ...
    it('should track circuit breaker failures', () => {
      service.updateCircuitBreakerState(ruleId, 'CLOSED', 'OPEN', 'Failure threshold reached', true);
  ...
  describe('disabled logging', () => {
    ...
    beforeEach(() => {
      ...
      disabledService = new GoRulesMonitoringService(disabledConfig, disabledLogger, metricsService);
    });
