...
describe('CrossPlatformPermissionUtils', () => {
  ...
  describe('directory validation', () => {
    ...
    it('should validate accessible directory', async () => {
      ...
      await expect(CrossPlatformPermissionUtils.validateRuleDirectory(dirPath))
  ...
  describe('validateFilePath', () => {
    it('should accept valid file paths', () => {
      ...
      for (const path of validPaths) {
        expect(() => CrossPlatformValidationUtils.validateFilePath(path))
          .not.toThrow();
      }
    });

    it('should reject empty paths', () => {
      expect(() => CrossPlatformValidationUtils.validateFilePath(''))
    ...
    it('should reject Windows reserved names', () => {
      ...
      for (const name of reservedNames) {
        expect(() => CrossPlatformValidationUtils.validateFilePath(name))
          .toThrow(MinimalGoRulesError);
      }
    });
    ...
    it('should reject paths that are too long', () => {
      ...
      expect(() => CrossPlatformValidationUtils.validateFilePath(longPath))
        .toThrow(MinimalGoRulesError);
    });
    ...
    it('should reject null character on all platforms', () => {
      ...
      for (const platform of platforms) {
        ...
        expect(() => CrossPlatformValidationUtils.validateFilePath('file\0name.json'))
          .toThrow(MinimalGoRulesError);
      }
    });
  });
...
describe('CrossPlatform Integration Tests', () => {
  ...
  beforeAll(async () => {
    ...
    await realFs.promises.writeFile(path.join(testDir, 'subdir', 'nested.json'), '{"nested": true}');
  });
  ...
  it('should validate real directory correctly', async () => {
    await expect(CrossPlatformPermissionUtils.validateRuleDirectory(testDir))
      .resolves.not.toThrow();
  });
