/**
 * Unit tests for MinimalRuleLoaderService
 */

import { MinimalRuleLoaderService } from './minimal-rule-loader-service.js';
...
describe('MinimalRuleLoaderService', () => {
  ...
  describe('constructor', () => {
    it('should initialize with correct configuration', () => {
      expect(service).toBeInstanceOf(MinimalRuleLoaderService);
    });
    ...
    it('should handle API URL with trailing slash', () => {
      ...
      expect(serviceWithSlash).toBeInstanceOf(MinimalRuleLoaderService);
    });
  });
