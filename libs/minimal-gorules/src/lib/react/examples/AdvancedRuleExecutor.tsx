 ...
 */
const CustomResultsComponent: React.FC<{ results: Record<string, unknown> | unknown }> = ({
  results,
}) => (
  <div
    style={{
    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        <div>
          ...
          <div style={{ marginBottom: '15px' }}>{renderExecutionConfig()}</div>
            ...
            {executionHistory.map((entry, index) => (
              ...
              >
                <div>
                  ...
                  <strong>Mode:</strong> {entry.mode} | <strong>Duration:</strong>{' '}
                  {entry.executionTime}ms | <strong>Status:</strong>{' '}
