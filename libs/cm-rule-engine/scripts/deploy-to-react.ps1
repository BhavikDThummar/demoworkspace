# Hardcoded paths
$SourcePath = "D:\Development\Q2C\Other\BOMDemoAPIApp\demoworkspace\libs\cm-rule-engine\dist\browser"
...
Write-Host "Starting deployment of cm-rule-engine to React application..." -ForegroundColor Green
