/**
 * Minimal Rule Loader Service for GoRules Cloud API integration
...
/**
 * Minimal Rule Loader Service implementation
 * Optimized for project-wide rule loading with minimal overhead
 */
export class MinimalRuleLoaderService implements IRuleLoaderService {
